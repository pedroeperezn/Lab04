...
public class BookStore {
     ...
     * If the name is "Amazon" (either lower case or uppercase), the new name will be "Chapters".
    ...
    /**
     * create book store with all the novel below
     */
    private void populateNovels() {
        ...
        novels.add(new Novel("Death Comes for the Archbishop", "Willia Cather", 1927));
        ...
        novels.add(new Novel("The French Lieutenant's Woman", "John Fowels", 1969));
        ...
        novels.add(new Novel("The Grapes of Warth", "John Steinbeck", 1939));
        ...
        novels.add(new Novel("Herzog", "Saul Bellor", 1964));
        ...
        novels.add(new Novel("The Sheltering Sky", "Paul Bowels", 1949));
        novels.add(new Novel("Slaugherhouse-Five", "Kurt Vonnegut", 1969));
    ...
    public void printTitlesContaining(String substring, boolean caseSensitive) throws IllegalArgumentException 
    {
        ...
        for (Novel novel : novels) {
            if (novel != null && novel.getTitle() != null && !novel.getTitle().isBlank()) {
                ...
                if (caseSensitive && title.contains(substring)) {
                    System.out.println(title);
                } else if (!caseSensitive && title.toLowerCase().contains(substring.toLowerCase())) {
                    System.out.println(title);
                }
            }
        }
    ...
    public void printNameStartsEndsWith(String substring) {
        for (Novel novel : novels) {
            if (novel != null && novel.getAuthorName() != null) {
                ...
                if (author.startsWith(substring.toLowerCase()) || author.endsWith(substring.toLowerCase())) {
    ...
    /**
     * Returns the longest title or author name based on the property provided.
    ...
    public String getLongest(String property) throws IllegalNovelPropertyException
    {
        ...
        if (property.equalsIgnoreCase("author")) {
            for (Novel novel : novels) {
                if (novel != null && novel.getAuthorName() != null) {
                    if (longest == null || novel.getAuthorName().length() > longest.length()) {
            ...
            for (Novel novel : novels) {
                if (novel != null && novel.getTitle() != null) {
                    if (longest == null || novel.getTitle().length() > longest.length()) {
    ...
    /**
     * The main method to create a BookStore object
     * @param args Command-line arguments; the first argument should be the store name.
     */
